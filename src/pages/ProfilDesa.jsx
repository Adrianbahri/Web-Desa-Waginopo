...
import StructureCard from '../components/profil/StructureCard';
import PokjaCard from '../components/profil/PokjaCard';
...
const dataAdministrasi = {
  peta: gambarPeta,
  total: { penduduk: 773, kk: 237, lk: 393, pr: 380 },
  dusun: [
    { nama: "Dusun Waginopo", penduduk: 368, kk: 116, lk: 186, pr: 182, warna: "bg-yellow-50", border: "border-yellow-200", text: "text-yellow-800", icon: "text-yellow-500", dot: "bg-yellow-500" },
    { nama: "Dusun Toliamba Jaya", penduduk: 405, kk: 121, lk: 207, pr: 198, warna: "bg-purple-50", border: "border-purple-200", text: "text-purple-800", icon: "text-purple-500", dot: "bg-purple-500" }
  ]
};
...
const strukturPemdes = {
  pimpinan: { nama: "La Rujali", jabatan: "Kepala Desa", color: "bg-red-600", foto: "/images/perangkat/kades.jpg" },
  sekretaris: { nama: "Ahirudin, ST", jabatan: "Sekretaris Desa", color: "bg-orange-600", foto: "/images/perangkat/sekdes.jpg" },
  kaur: [
...
const strukturPKK = {
  ...
  pokja: [
    { id: "I", ketua: "Ny. Wa Ode Hajrina", sekretaris: "Ny. Nulfa Asrianti" },
    { id: "II", ketua: "Ny. Wa Leni", sekretaris: "Ny. Jumiati D" },
    { id: "III", ketua: "Ny. Ratna", sekretaris: "Ny. Waria" },
    { id: "IV", ketua: "Ny. Wa Juwi", sekretaris: "Ny. Wa Aruwi" },
  ]
};
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-16">
            <section>
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-start">
                <div className="bg-white p-2 rounded-3xl shadow-lg border border-gray-200 cursor-pointer transform hover:scale-[1.01] transition-all duration-300 relative group" onClick={() => setZoomImage(dataAdministrasi.peta)}>
                  <div className="relative rounded-2xl overflow-hidden bg-slate-100">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black/10 opacity-0 group-hover:opacity-100 transition-opacity">
                      <span className="bg-white text-gray-900 px-4 py-2 rounded-full font-bold shadow-xl text-sm flex items-center gap-2">Lihat Peta Besar</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="w-full overflow-x-auto pb-6">
                <div className="flex flex-col items-center gap-6 min-w-[320px]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative w-full justify-items-center">
                    ...
                    <div className="flex flex-col items-center"><StructureCard {...strukturBPD.wakil} sub color="bg-slate-600" /></div>
                    <div className="flex flex-col items-center"><StructureCard {...strukturBPD.sekretaris} sub color="bg-slate-600" /></div>
                  </div>
  ...
  return (
    <PageLayout className="bg-white">
      <PageHeader
        badge="Profil Resmi"
        title="Desa Waginopo"
        subtitle="Kecamatan Wangi-Wangi, Kabupaten Wakatobi."
      />
        ...
        <div className="container mx-auto max-w-4xl bg-white rounded-2xl shadow-xl p-2 border border-gray-100 flex flex-wrap justify-center gap-2">
          {['Selayang Pandang', 'geografis', 'struktur'].map((item) => (
            <button
              ...
              className={`px-6 py-3 rounded-xl text-sm font-bold uppercase tracking-wider transition-all duration-300 flex-1 md:flex-none ${activeTab === item ? 'bg-green-700 text-white shadow-lg transform -translate-y-1' : 'text-gray-500 hover:bg-gray-50 hover:text-green-700'}`}
            >
              {item.replace('geografis', 'Geografis').replace('struktur', 'Struktur')}
            </button>
          ))}
        </div>
      </section>
